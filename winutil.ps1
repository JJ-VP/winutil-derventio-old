...
Function Install-WinUtilProgramWinget {
    ...
    Foreach ($Program in $($ProgramsToInstall -split ",")){
        ...
        if($manage -eq "Installing"){
            Start-Process -FilePath winget -ArgumentList "install -e -s winget --accept-source-agreements --accept-package-agreements --silent $Program" -NoNewWindow -Wait
        }
        if($manage -eq "Uninstalling"){
            Start-Process -FilePath winget -ArgumentList "remove -e -s winget --purge --force --silent $Program" -NoNewWindow -Wait
        }
                    ...
                    <TabItem Header="Config" Visibility="Collapsed" Name="WPFTab3">
                        <Grid Background="#444444">
                            ...
                            <StackPanel Background="#777777" SnapsToDevicePixels="True" Grid.Column="2" Margin="10,5">
                                <Label Content="Derventio Options" FontSize="16"/>
                                <Button Name="WPFInstallKaspersky" FontSize="14" Background="AliceBlue" Content="Install Kaspersky" HorizontalAlignment = "Left" Margin="5" Padding="20,5" Width="200"/>
                                <Button Name="WPFInstallFS" FontSize="14" Background="AliceBlue" Content="Install FS Agent" HorizontalAlignment = "Left" Margin="5" Padding="20,5" Width="200"/>
                                <Button Name="WPFInstallVPN" FontSize="14" Background="AliceBlue" Content="Install VPN" HorizontalAlignment = "Left" Margin="5" Padding="20,5" Width="200"/>
                                <Button Name="WPFDerventioSettings" FontSize="14" Background="AliceBlue" Content="Set Preferences" HorizontalAlignment = "Left" Margin="5" Padding="20,5" Width="200"/>
                            </StackPanel>
                        </Grid>
                    </TabItem>
