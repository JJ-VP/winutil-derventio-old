                    ...
                    <TabItem Header="Config" Visibility="Collapsed" Name="Tab3">
                        <Grid Background="#444444">
                            ...
                            <StackPanel Background="#777777" SnapsToDevicePixels="True" Grid.Column="2" Margin="10,5">
                                <Label Content="Derventio Additional options" FontSize="16"/>
                                <Button Name="installKaspersky" FontSize="14" Background="AliceBlue" Content="Install Kaspersky" HorizontalAlignment = "Left" Margin="5" Padding="20,5" Width="200"/>
                                <Button Name="installFS" FontSize="14" Background="AliceBlue" Content="Install FS Agent" HorizontalAlignment = "Left" Margin="5" Padding="20,5" Width="200"/>
                                <Button Name="installVPN" FontSize="14" Background="AliceBlue" Content="Install VPN" HorizontalAlignment = "Left" Margin="5" Padding="20,5" Width="200"/>
                                <Button Name="DerventioSettings" FontSize="14" Background="AliceBlue" Content="Set Preferences" HorizontalAlignment = "Left" Margin="5" Padding="20,5" Width="200"/>
                            </StackPanel>
                        </Grid>
                    </TabItem>
